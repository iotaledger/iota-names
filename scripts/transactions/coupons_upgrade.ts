...
const couponsUpgrade = async () => {
	...
	const upgradeCall = `iota client upgrade --upgrade-capability ${mainPackage[network].coupons.upgradeCap} --gas-budget 2000000000 --gas ${gasObjectId} --skip-dependency-verification --serialize-unsigned-transaction`;
