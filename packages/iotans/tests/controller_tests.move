...
#[test_only]
module iotans::controller_tests;
...
fun test_init(): Scenario {
    ...
    let scenario = &mut scenario_val;
    {
        ...
        iotans::authorize_app_for_testing<Controller>(&mut iotans);
...
public fun set_target_address_util(
    ...
    set_target_address_for_testing(&mut iotans, &nft, target, &clock);
...
public fun set_user_data_util(
    ...
    clock.increment_for_testing(clock_tick);
    set_user_data_for_testing(&mut iotans, &nft, key, value, &clock);
...
public fun unset_user_data_util(
    ...
    clock.increment_for_testing(clock_tick);
    unset_user_data_for_testing(&mut iotans, &nft, key, &clock);
