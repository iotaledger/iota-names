...
#[test]
#[expected_failure(abort_code = iotans::config::ENoYears)]
fun calculate_price_years_fail() {
    default().calculate_price(3, 0);
}

#[test]
#[expected_failure(abort_code = iotans::config::ELabelTooShort)]
fun calculate_price_length_min_fail() {
    default().calculate_price(2, 1);
}

#[test]
#[expected_failure(abort_code = iotans::config::ELabelTooLong)]
fun calculate_price_length_max_fail() {
    default().calculate_price(255, 1);
}

#[test]
#[expected_failure(abort_code = iotans::config::EInvalidPublicKey)]
