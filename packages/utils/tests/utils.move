...
fun test_init(): Scenario {
    ...
    let scenario = &mut scenario_val;
    {
        ...
        iota_names::authorize_app_for_testing<Utilities>(&mut iota_names);
...
fun deauthorize_app_util(scenario: &mut Scenario) {
    ...
    iota_names::deauthorize_app<Utilities>(&admin_cap, &mut iota_names);
...
fun test_set_target_address_aborts_if_utilities_is_deauthorized() {
    let mut scenario_val = test_init();
    let scenario = &mut scenario_val;
    setup(scenario, FIRST_ADDRESS, 0);
...
#[test, expected_failure(abort_code = ::iota_names::iota_names::EAppNotAuthorized)]
fun test_set_reverse_lookup_aborts_if_utilities_is_deauthorized() {
    let mut scenario_val = test_init();
    let scenario = &mut scenario_val;
    setup(scenario, FIRST_ADDRESS, 0);
...
#[test, expected_failure(abort_code = ::iota_names::iota_names::EAppNotAuthorized)]
fun test_unset_reverse_lookup_if_utilities_is_deauthorized() {
    let mut scenario_val = test_init();
    let scenario = &mut scenario_val;
    setup(scenario, FIRST_ADDRESS, 0);
...
#[test, expected_failure(abort_code = utils::EUnsupportedKey)]
...
#[test, expected_failure(abort_code = ::iota_names::iota_names::EAppNotAuthorized)]
fun test_set_user_data_aborts_if_utilities_is_deauthorized() {
    let mut scenario_val = test_init();
    let scenario = &mut scenario_val;
    setup(scenario, FIRST_ADDRESS, 0);
...
#[test, expected_failure(abort_code = ::iota_names::iota_names::EAppNotAuthorized)]
fun test_unset_user_data_works_if_utilities_is_deauthorized() {
    let mut scenario_val = test_init();
    let scenario = &mut scenario_val;
    setup(scenario, FIRST_ADDRESS, 0);
