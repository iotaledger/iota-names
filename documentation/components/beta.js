...
const Beta = () => {
  ...
  return (
    <>
      ...
      {isLanding &&
        <div className="mt-6">
          <p className="nx-mt-6 nx-leading-7 first:nx-mt-0">The main point of failure MVR users need to be aware of is the experimental indexer backing the registry. Whether you run your own instance of the MVR indexer or use the IOTA operated public good indexer, there is always risk that the service is not available, so build your application accordingly.</p>
