...
<Callout type="warning">
    These examples assume that you use the MVR plugin for the IOTA Typescript SDK, as described in the  [`Typescript SDK`](/move-registry/tooling/typescript-sdk) section.
</Callout>
...
const git = transaction.moveCall({
    ...
    arguments: [
        transaction.pure.string('<Your git repository, e.g. `https://github.com/iotaledger/mvr`>'),
...
build custom access control for your object, you can utilize a transfer to object workflow (see [Transfer to Object](https://docs.iota.org/concepts/transfers/transfer-to-object) on the IOTA documentation site for more information).
