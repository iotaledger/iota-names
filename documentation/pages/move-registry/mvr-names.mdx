...
To create a new application, you must provide an IOTA-Names name and a package name, as long as it is not 
already registered.
...
const appCap = transaction.moveCall({
    ...
    arguments: [
        // the registry obj: Can also be resolved as `registry-obj@mvr` from mainnet IOTA-Names.
        transaction.object('0x0e5d473a055b6b7d014af557a13ad9075157fdc19b6d51562a18511afd397727'),
        transaction.object(iotaNamesObjectId),
