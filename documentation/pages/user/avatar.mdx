...
1. Approve the transaction using your connected wallet. After the transaction completes, your avatar becomes associated with your address and appears with your IOTA name wherever avatars are supported.
