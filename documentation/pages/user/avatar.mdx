...
To assign an owned NFT to your IOTA-Names name:
...
1. Approve the transaction using your connected wallet. After the transaction completes, your avatar becomes associated with your address and appears with your IOTA-Names name wherever avatars are supported.
