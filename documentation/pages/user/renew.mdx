...
<Player videoFilename="iotans-howto-renew"/>
...
When the current date surpasses the last day of your registration period, the IOTANS name expires. You have a thirty-day grace period within which you can renew the registration. After that, you must [register](./registration.mdx) the name again, if it's available.
