...
1. **Proposal Categories:** Proposals should be classified into one of four main categories:
  - **Technical Proposals**, including changes to the protocol or technical aspects of the IOTANS system. These types of proposals will have to include definitive code changes/updates.
...
1. **Voting Mechanism:** Voting will be conducted on designated IOTANS governance platforms. Each token represents one vote, and votes can be cast in favor, against, or abstain.
1. **No Violation of Laws:**  Approved votes that could result in a violation of IOTANS Foundation directors’ fiduciary duties or applicable law may be vetoed by the IOTANS Foundation directors by a vote of a majority of the directors seated.   
1. **Majority requirements:**
    ...
    - **Supermajority:** Constitutional amendments or critical changes require a two-thirds majority (66%) of votes cast. The types of proposals that would fall into the Supermajority category include:
      1. **Constitutional Amendments:** Changes to the IOTA Name Service governance rules or core governing principles require a supermajority. This ensures that fundamental rules are only changed with broad consensus.
...
- **Benefit to IOTANS Ecosystem:** An explanation of how the proposal will benefit the IOTANS ecosystem, and how it aligns with the IOTANS Community’s core mission and values.
- **Key Terms (optional):** Definitions of any terms within the proposal that are unique to the proposal, new to the IOTANS Community, and/or industry-specific.
- **Platforms and Technologies:** A detailed breakdown of the platforms and technologies that will be used.
- **Steps to Implement & Timeline:** An outline of the steps to implement the proposal, including associated costs, key performance indicators, personnel requirements, any expectations of the IOTANS Foundation, and other resources needed for each step where applicable. This section also provides relevant timing details, including the project’s start date and key milestones.
...
- **Moderating Party:** On-Chain address which can approve of completion of proposal requirements. Can be a community member/multisig wallet but will initially be a IOTANS Foundation wallet.
- **Code Packet:** On-chain representation object of code upgrade required to make additions or changes to the IOTANS protocol.
