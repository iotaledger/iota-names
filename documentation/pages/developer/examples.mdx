...
## Transferring any object to an IOTA-Names name fully on-chain

The following `demo` module demonstrates how to transfer an object of any type to an IOTA-Names name. This is a basic example of how to interact with IOTA-Names on chain.
