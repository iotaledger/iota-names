...
| --- | --- | --- |
| Has NFT | ✅ Yes, <ul style={{listStyle: 'disc', paddingLeft: 1 + 'rem'}}><li>`NameRegistration` for SLD*</li><li>`SubnameRegistration` for nested names</li></ul> | ❌ No, parent's NFT acts as the capability |
...
*SLD - Second-level name (for instance, example in example.iota)*
