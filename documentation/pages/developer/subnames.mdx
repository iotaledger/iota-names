...
| --- | --- | --- |
| Has NFT | ✅ Yes, <ul style={{listStyle: 'disc', paddingLeft: 1 + 'rem'}}><li>`NameRegistration` for SLD*</li><li>`SubdomainRegistration` for nested names</li></ul> | ❌ No, parent's NFT acts as the capability |
